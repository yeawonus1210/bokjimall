...
class="absolute top-0 left-0 z-50 flex flex-col items-center justify-between hidden w-full h-64 pt-5 mt-24 text-sm text-gray-800 bg-white border-t border-gray-200 md:w-auto md:flex-row md:h-24 lg:text-base md:bg-transparent md:mt-0 md:border-none md:py-0 md:flex md:relative">
      ...
      <br><br><br>
      <div class="box">   
      <h2 class="reg">글내용 확인</h2>
      <br><br>
      <center>
      <table width="500" cellpadding="2" cellspacing="0" border="1">
      <form action="${pageContext.servletContext.contextPath}/main/modify" method="post" >
         ...
         <tr>
            <td colspan="2" align="center"><input class="bt2" type="submit" value="수정하기"/>
                        &nbsp;&nbsp;&nbsp;<a class="list_b" href ="${pageContext.servletContext.contextPath}/main/qna">목록보기</a>
                        &nbsp;&nbsp;&nbsp;<a class="del_b" href="${pageContext.servletContext.contextPath}/main/delete?bNo=${contentView.bNo}">삭제</a>
                        &nbsp;&nbsp;&nbsp;<a class="anw_b" href="${pageContext.servletContext.contextPath}/main/replyForm?bNo=${contentView.bNo}">답변</a>
            </td>
         </tr>
      </form>      
      </table>   
