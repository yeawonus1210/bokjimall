            ...
            <div class="row">
                ...
                <div class="col-lg-5">  
                    ...
                    <div id="form" class="card mb-4">
                        <img id="fruit_kiwi" src="<%=request.getContextPath()%>/resources/img/electronics/biskabedcleaner.png">
                        <div class="card-body">
                            <div class="small text-muted"><p id="font_red">상세 정보</p></div>
                            <p>2021년형<br>
                               진드기 박멸 / 세균 박멸 / 48시간 사용 후 충전<br>
                            소비 효율 등급 1등급 인증</p>
                            <hr>
                            <p class="card-text">
                            <form>
                               <table id="kiwi_review">
                                  <tr>
                                     <td><img id="fruit_kiwi_review" src="<%=request.getContextPath()%>/resources/img/electronics/biskabedcleaner.png">&nbsp;&nbsp;</td>
                                     <td id="recommand"><center>⭐추천 리뷰⭐</center>
                                     <p>침구에 먼지가 이렇게 많은지 정말 몰랐어요,,,
                                     사길잘했어요!
                                     </td>
                               </table>
                            </form>
               ...
               <br><br>
               &nbsp;&nbsp;&nbsp;합리적인 가격과 최고급 성능 보장
               <p id="title_kiwi">&nbsp;비스카 침구 클리너</p>
               <p id="dollar"><strong>&nbsp;&nbsp;150,000원</strong></p>
               <hr>
            <br>
               <strong>&nbsp;&nbsp;&nbsp;👉👉혜택</strong>
               &nbsp;&nbsp;&nbsp;✔2개이상 구매시 30% 할인<br>
