            ...
            <div class="row">
                ...
                <div class="col-lg-5">  
                    ...
                    <div id="form" class="card mb-4">
                        <img id="fruit_kiwi" src="<%=request.getContextPath()%>/resources/img/electronics/dysondry.jpg">
                        <div class="card-body">
                            <div class="small text-muted"><p id="font_red">상세 정보</p></div>
                            <p>2021년형<br>
                               머리결 손상 최소화 / 손 데임 방지 / 쉬운 사용법<br>
                            소비 효율 등급 1등급 인증</p>
                            <hr>
                            <p class="card-text">
                            <form>
                               <table id="kiwi_review">
                                  <tr>
                                     <td><img id="fruit_kiwi_review" src="<%=request.getContextPath()%>/resources/img/electronics/dysondry.jpg">&nbsp;&nbsp;</td>
                                     <td id="recommand"><center>⭐추천 리뷰⭐</center>
                                     <p>똥손인데 정말 쉽게 머리할 수 있어요 추천합니다!
               ...
               <br><br>
               &nbsp;&nbsp;&nbsp;어디에서도 없는 파격 할인가
               <p id="title_kiwi">&nbsp;다이슨 헤어 드라이기</p>
               <p id="dollar"><strong>&nbsp;&nbsp;386,000원~(선착순 한정)</strong></p>
               <hr>
            <br>
               <strong>&nbsp;&nbsp;&nbsp;👉👉혜택</strong>
               &nbsp;&nbsp;&nbsp;✔무이자 할부 6개월<br>
               &nbsp;&nbsp;&nbsp;✔리뷰 등록 시 3,000원 복지포인트 적립<br>
               &nbsp;&nbsp;&nbsp;✔무상 수리 보증 2년
               <br>
               <br>
