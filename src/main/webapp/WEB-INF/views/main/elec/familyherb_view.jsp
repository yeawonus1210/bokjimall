            ...
            <div class="row">
                ...
                <div class="col-lg-5">  
                    ...
                    <div id="form" class="card mb-4">
                        <img id="fruit_kiwi" src="<%=request.getContextPath()%>/resources/img/electronics/familyherbmachine.jpg">
                        <div class="card-body">
                            <div class="small text-muted"><p id="font_red">상세 정보</p></div>
                            <p>2021년형<br>
                             얼음 정수기 냉장고/ 냉장고 내부 확인 가능한 패드 부착 / 넉넉한 수납공간<br>
                            소비 효율 등급 1등급 인증</p>
                            <hr>
                            <p class="card-text">
                            <form>
                               <table id="kiwi_review">
                                  <tr>
                                     <td><img id="fruit_kiwi_review" src="<%=request.getContextPath()%>/resources/img/electronics/familyherbmachine.jpg">&nbsp;&nbsp;</td>
                                     <td id="recommand"><center>⭐추천 리뷰⭐</center>
                                     <p>뭐가 필요한지 그때그때 알 수 있어서 너무 편리합니다. 강추!!
                                     </td>
                               </table>
                            </form>
                ...
                <div class="col-lg-5">
                  ...
                  &nbsp;&nbsp;&nbsp;⭐⭐⭐⭐⭐ >> 100개의 리뷰 더 보기
               <br><br>
               &nbsp;&nbsp;&nbsp;최신 기술들을 한곳에 모은 신형 냉장고
               <p id="title_kiwi">&nbsp;삼성 패밀리 허브 냉장고</p>
               <p id="dollar"><strong>&nbsp;&nbsp;4,000,000원</strong></p>
               <hr>
            <br>
               <strong>&nbsp;&nbsp;&nbsp;👉👉혜택</strong>
               &nbsp;&nbsp;&nbsp;✔삼성의 다른 제품과 함께 구매시 20% 할인<br>
               &nbsp;&nbsp;&nbsp;✔리뷰 등록 시 100,000원 복지포인트 적립<br>
               &nbsp;&nbsp;&nbsp;✔무상 수리 보증 5년
               <br>
               <br>
               ...
               <form id="contect">
                  <table>
                     <tr>
                        ...
                        <td><a href="${pageContext.servletContext.contextPath}/main/elec/philpssenseIQdry_view">
                        <img id="fruit_strawberry_contect" src="<%=request.getContextPath()%>/resources/img/electronics/philpssenseIQdry.jpg"></a>&nbsp;&nbsp;&nbsp;&nbsp;</td>
                        
                        <td><a href="${pageContext.servletContext.contextPath}/main/elec/refrig_view">
                        <img id="fruit_mango_contect" src="<%=request.getContextPath()%>/resources/img/electronics/BESPOKEmachine.jpg"></a>&nbsp;&nbsp;&nbsp;&nbsp;</td>
                        
                        <td><a href="${pageContext.servletContext.contextPath}/main/elec/biskabedcleaner_view">
                        <img id="fruit_peach_contect" src="<%=request.getContextPath()%>/resources/img/electronics/biskabedcleaner.png"></a>&nbsp;&nbsp;&nbsp;&nbsp;</td>

                     </tr>
                     
                     <tr id="write">
                        <td>필립스 센스IQ 드라이기  </td>
                        <td>삼성 BESPOKE 냉장고  </td>
                        <td>비스카 침구 청소기</td>
                     </tr>
                  </table>
