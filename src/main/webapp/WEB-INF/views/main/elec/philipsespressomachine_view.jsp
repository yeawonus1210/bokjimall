            ...
            <div class="row">
                ...
                <div class="col-lg-5">  
                    ...
                    <div id="form" class="card mb-4">
                        <img id="fruit_kiwi" src="<%=request.getContextPath()%>/resources/img/electronics/philipsespressomachine.jpg">
                        <div class="card-body">
                            <div class="small text-muted"><p id="font_red">상세 정보</p></div>
                            <p>2021년형<br>
                               카페용 / 12가지종류의 커피 옵션 / 쉬운 머신 청소<br>
                            소비 효율 등급 1등급 인증</p>
                            <hr>
                            <p class="card-text">
                            <form>
                               <table id="kiwi_review">
                                  <tr>
                                     <td><img id="fruit_kiwi_review" src="<%=request.getContextPath()%>/resources/img/electronics/philipsespressomachine.jpg">&nbsp;&nbsp;</td>
                                     <td id="recommand"><center>⭐추천 리뷰⭐</center>
                                     <p>카페를 갈 이유가 없습니다,,최고입니다.
               ...
               <br><br>
               &nbsp;&nbsp;&nbsp;집에서 즐기는 카페
               <p id="title_kiwi">&nbsp;필립스 에스프레소 머신</p>
               <p id="dollar"><strong>&nbsp;&nbsp;500,000원</strong></p>
               <hr>
            <br>
               <strong>&nbsp;&nbsp;&nbsp;👉👉혜택</strong>
               &nbsp;&nbsp;&nbsp;✔무이자 할부 3개월<br>
               &nbsp;&nbsp;&nbsp;✔리뷰 등록 시 5,000원 복지포인트 적립<br>
               &nbsp;&nbsp;&nbsp;✔무상 수리 보증 2년
               <br>
               <br>
               ...
               <form id="contect">
                  <table>
                     <tr>
                        ...
                        <img id="fruit_strawberry_contect" src="<%=request.getContextPath()%>/resources/img/electronics/biskabedcleaner.png"></a></td>
                        
                        <td><a href="${pageContext.servletContext.contextPath}/main/elec/watermachine_view">
                        <img id="fruit_mango_contect" src="<%=request.getContextPath()%>/resources/img/electronics/chunghowatermachine.png"></a></td>
                        
                        <td><a href="${pageContext.servletContext.contextPath}/main/elec/dysondry_view">
                        <img id="fruit_peach_contect" src="<%=request.getContextPath()%>/resources/img/electronics/dysondry.jpg"></a></td>
