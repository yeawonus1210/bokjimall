            ...
            <div class="row">
                ...
                <div class="col-lg-5">  
                    ...
                    <div id="form" class="card mb-4">
                        <img id="fruit_kiwi" src="<%=request.getContextPath()%>/resources/img/electronics/philpssenseIQdry.jpg">
                        <div class="card-body">
                            <div class="small text-muted"><p id="font_red">상세 정보</p></div>
                            <p>2021년형<br>
                               머리결 손상 최소화 / 세척 가능 / 머리가 빨리 마르는 헤어드라이기<br>
                            소비 효율 등급 1등급 인증</p>
                            <hr>
                            <p class="card-text">
                            <form>
                               <table id="kiwi_review">
                                  <tr>
                                     <td><img id="fruit_kiwi_review" src="<%=request.getContextPath()%>/resources/img/electronics/philpssenseIQdry.jpg">&nbsp;&nbsp;</td>
                                     <td id="recommand"><center>⭐추천 리뷰⭐</center>
                                     <p>머리를 정말 2분이면 말려요!!! 간편하고 좋습니다.
               ...
               <br><br>
               &nbsp;&nbsp;&nbsp;어디에서도 없는 파격 할인가
               <p id="title_kiwi">&nbsp;필립스 IQ 헤어 드라이기</p>
               <p id="dollar"><strong>&nbsp;&nbsp;86,000원</strong></p>
               <hr>
            <br>
               <strong>&nbsp;&nbsp;&nbsp;👉👉혜택</strong>
               &nbsp;&nbsp;&nbsp;✔모든 구매고객에게 롤빗 증정<br>
               &nbsp;&nbsp;&nbsp;✔리뷰 등록 시 1,000원 복지포인트 적립<br>
               &nbsp;&nbsp;&nbsp;✔무상 수리 보증 1년
               <br>
               <br>
               ...
               <form id="contect">
                  <table>
                     <tr>
                        ...
                        <td><a href="${pageContext.servletContext.contextPath}/main/elec/familyherb_view">
                        <img id="fruit_strawberry_contect" src="<%=request.getContextPath()%>/resources/img/electronics/familyherbmachine.jpg"></a>&nbsp;&nbsp;&nbsp;&nbsp;</td>
                        ...
                        <td><a href="${pageContext.servletContext.contextPath}/main/elec/watermachine_view">
                        <img id="fruit_peach_contect" src="<%=request.getContextPath()%>/resources/img/electronics/chunghowatermachine.png"></a>&nbsp;&nbsp;&nbsp;&nbsp;</td>
