            ...
            <div class="row">
                ...
                <div class="col-lg-5">  
                    ...
                    <div id="form" class="card mb-4">
                        <img id="fruit_kiwi" src="<%=request.getContextPath()%>/resources/img/electronics/BESPOKEmachine.jpg">
                        <div class="card-body">
                            <div class="small text-muted"><p id="font_red">상세 정보</p></div>
                            <p>2021년형<br>
                               컬러조합 가능 / 6단계 온도조절 / BESPOKE 4Door<br>
                            소비 효율 등급 1등급 인증</p>
                            <hr>
                            <p class="card-text">
                            <form>
                               <table id="kiwi_review">
                                  <tr>
                                     <td><img id="fruit_kiwi_review" src="<%=request.getContextPath()%>/resources/img/electronics/BESPOKEmachine.jpg"></td>
                                     <td id="recommand"><center>⭐추천 리뷰⭐</center>
                                     <p>역시 삼성이네요..! 너무 좋아요!!</td>
                               </table>
                            </form>
               ...
               <br><br>
               &nbsp;&nbsp;&nbsp;국내 전자제품 부문 전체 1위
               <p id="title_kiwi">&nbsp;삼성 비스포크 냉장고</p>
               <p id="dollar"><strong>&nbsp;&nbsp;3,400,000원~</strong></p>
               <hr>
            <br>
               <strong>&nbsp;&nbsp;&nbsp;👉👉혜택</strong>
               &nbsp;&nbsp;&nbsp;✔냉장고 2개이상 구매시 개당 50만원 할인<br>
               &nbsp;&nbsp;&nbsp;✔리뷰 등록 시 10,000원 복지포인트 적립<br>
               &nbsp;&nbsp;&nbsp;✔무상 수리 보증 5년
               <br>
               <br>
               ...
               <form id="contect">
                  <table>
                     <tr>
                        ...
                        <td><a href="${pageContext.servletContext.contextPath}/main/elec/dysondry_view">
                        <img id="fruit_strawberry_contect" src="<%=request.getContextPath()%>/resources/img/electronics/dysondry.jpg"></a>&nbsp;&nbsp;&nbsp;&nbsp;</td>
                        
                        <td><a href="${pageContext.servletContext.contextPath}/main/elec/robotmachine_view">
                        <img id="fruit_mango_contect" src="<%=request.getContextPath()%>/resources/img/electronics/robotmachine.jpg"></a>&nbsp;&nbsp;&nbsp;&nbsp;</td>
                        
                        <td><a href="${pageContext.servletContext.contextPath}/main/elec/philipsespressomachine_view">
                        <img id="fruit_peach_contect" src="<%=request.getContextPath()%>/resources/img/electronics/philipsespressomachine.jpg"></a>&nbsp;&nbsp;&nbsp;&nbsp;</td>
