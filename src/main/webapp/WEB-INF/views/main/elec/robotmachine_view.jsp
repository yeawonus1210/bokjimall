            ...
            <div class="row">
                ...
                <div class="col-lg-5">  
                    ...
                    <div id="form" class="card mb-4">
                        <img id="fruit_kiwi" src="<%=request.getContextPath()%>/resources/img/electronics/robotmachine.jpg">
                        <div class="card-body">
                            <div class="small text-muted"><p id="font_red">상세 정보</p></div>
                            <p>2021년형<br>
                               최신 AI 기술 탑재 / 자가충전형 / 4가지 모드<br>
                            소비 효율 등급 1등급 인증</p>
                            <hr>
                            <p class="card-text">
                            <form>
                               <table id="kiwi_review">
                                  <tr>
                                     <td><img id="fruit_kiwi_review" src="<%=request.getContextPath()%>/resources/img/electronics/robotmachine.jpg">&nbsp;&nbsp;</td>
               ...
               <br><br>
               &nbsp;&nbsp;&nbsp;최신 AI 기술 탑재
               <p id="title_kiwi">&nbsp;삼성 로봇 청소기</p>
               <p id="dollar"><strong>&nbsp;&nbsp;1,400,000원</strong></p>
               <hr>
            <br>
               <strong>&nbsp;&nbsp;&nbsp;👉👉혜택</strong>
               &nbsp;&nbsp;&nbsp;✔모든 구매고객 필터 무료 증정<br>
               &nbsp;&nbsp;&nbsp;✔리뷰 등록 시 14,000원 복지포인트 적립<br>
               &nbsp;&nbsp;&nbsp;✔무상 수리 보증 2년
               <br>
               <br>
               ...
               <form id="contect">
                  <table>
                     <tr>
                        ...
                        <img id="fruit_strawberry_contect" src="<%=request.getContextPath()%>/resources/img/electronics/philipsespressomachine.jpg"></a></td>
                        
                        <td><a href="${pageContext.servletContext.contextPath}/main/elec/familyherb_view">
                        <img id="fruit_mango_contect" src="<%=request.getContextPath()%>/resources/img/electronics/familyherbmachine.jpg"></a></td>
