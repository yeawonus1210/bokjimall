            ...
            <div class="row">
                ...
                <div class="col-lg-5">  
                    ...
                    <div id="form" class="card mb-4">
                        <img id="fruit_kiwi" src="<%=request.getContextPath()%>/resources/img/electronics/chunghowatermachine.png">
                        <div class="card-body">
                            <div class="small text-muted"><p id="font_red">상세 정보</p></div>
                            <p>2021년형<br>
                               얼음 정수기 / 다양한 물 옵션 / 미네랄 정수기<br>
                            소비 효율 등급 1등급 인증</p>
                            <hr>
                            <p class="card-text">
                            <form>
                               <table id="kiwi_review">
                                  <tr>
                                     <td><img id="fruit_kiwi_review" src="<%=request.getContextPath()%>/resources/img/electronics/chunghowatermachine.png">&nbsp;&nbsp;</td>
                                     <td id="recommand"><center>⭐추천 리뷰⭐</center>
                                     <p>얼음을 따로 얼리지 않아도 되서 매우 좋아요!!
                                     </td>
                               </table>
                            </form>
               ...
               <br><br>
               &nbsp;&nbsp;&nbsp;얼음이 함께 나오는 정수기
               <p id="title_kiwi">&nbsp;청호 얼음 정수기</p>
               <p id="dollar"><strong>&nbsp;&nbsp;600,000원</strong></p>
               <hr>
            <br>
               <strong>&nbsp;&nbsp;&nbsp;👉👉혜택</strong>
               &nbsp;&nbsp;&nbsp;✔2개 이상 구매 시 각 20% 할인<br>
               ...
               <form id="contect">
                  <table>
                     <tr>
                        ...
                        <img id="fruit_strawberry_contect" src="<%=request.getContextPath()%>/resources/img/electronics/robotmachine.jpg"></a>&nbsp;&nbsp;&nbsp;&nbsp;</td>
                        
                        <td><a href="${pageContext.servletContext.contextPath}/main/elec/dysondry_view">
                        <img id="fruit_mango_contect" src="<%=request.getContextPath()%>/resources/img/electronics/dysondry.jpg"></a>&nbsp;&nbsp;&nbsp;&nbsp;</td>
