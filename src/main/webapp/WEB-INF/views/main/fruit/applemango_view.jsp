            ...
            <div class="row">
                ...
                <div class="col-lg-5">  
                    ...
                    <div id="form" class="card mb-4">
                        <img id="fruit_kiwi" src="<%=request.getContextPath()%>/resources/img/fruit/applemango.jpg">
                        <div class="card-body">
                            <div class="small text-muted"><p id="font_red">상세 정보</p></div>
                            <p>싱싱한 애플망고 한번 사면 계속 사고 싶어지는 과일<br>
                            ...
                            <form>
                               <table id="kiwi_review">
                                  <tr>
                                     <td><img id="fruit_kiwi_review" src="<%=request.getContextPath()%>/resources/img/fruit/applemango.jpg">&nbsp;&nbsp;</td>
               ...
               <br><br>
               &nbsp;&nbsp;&nbsp;복지몰 1등 애플망고 상품, 국내산 ! ! !
               <p id="title_kiwi">&nbsp;애플망고</p>
               <p id="dollar"><strong>&nbsp;&nbsp;4kg : 50000원</strong></p>
               <hr>
			   <br>
               <strong>&nbsp;&nbsp;&nbsp;👉👉혜택</strong>
               ...
               <form id="contect">
                  <table>
                     <tr>
                        ...
                        <img id="fruit_strawberry_contect" src="<%=request.getContextPath()%>/resources/img/fruit/참외.jpg"></a>&nbsp;&nbsp;&nbsp;&nbsp;</td>
                        ...
                        <td><a href="${pageContext.servletContext.contextPath}/main/fruit/strawberry_view">
                        <img id="fruit_peach_contect" src="<%=request.getContextPath()%>/resources/img/fruit/strawberry.jpg"></a>&nbsp;&nbsp;&nbsp;&nbsp;</td>
