            ...
            <div class="row">
                ...
                <div class="col-lg-5">  
                    ...
                    <div id="form" class="card mb-4">
                        <img id="fruit_kiwi" src="<%=request.getContextPath()%>/resources/img/fruit/수박.png">
                        <div class="card-body">
                            <div class="small text-muted"><p id="font_red">상세 정보</p></div>
                            <p>싱싱한 수박 한번 사면 계속 사고 싶어지는 과일<br>
                            ...
                            <form>
                               <table id="kiwi_review">
                                  <tr>
                                     <td><img id="fruit_kiwi_review" src="<%=request.getContextPath()%>/resources/img/fruit/수박.png">&nbsp;&nbsp;</td>
               ...
               <form id="contect">
                  <table>
                     <tr>
                        ...
                        <img id="fruit_strawberry_contect" src="<%=request.getContextPath()%>/resources/img/fruit/peach.jpg"></a>&nbsp;&nbsp;&nbsp;&nbsp;</td>
                        
                        <td><a href="${pageContext.servletContext.contextPath}/main/fruit/shinemucat_view">
                        <img id="fruit_mango_contect" src="<%=request.getContextPath()%>/resources/img/fruit/shinemucat.jpg"></a>&nbsp;&nbsp;&nbsp;&nbsp;</td>
