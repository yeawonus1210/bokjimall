            ...
            <div class="row">
                ...
                <div class="col-lg-5">  
                    ...
                    <div id="form" class="card mb-4">
                        <img id="fruit_kiwi" src="<%=request.getContextPath()%>/resources/img/kitchenware/fishgoodbye.jpg">
                        <div class="card-body">
                            ...
                            <form>
                               <table id="kiwi_review">
                                  <tr>
                                     <td><img id="fruit_kiwi_review" src="<%=request.getContextPath()%>/resources/img/kitchenware/fishgoodbye.jpg">&nbsp;&nbsp;;</td>
               ...
               <form id="contect">
                  <table>
                     <tr>
                        ...
                        <img id="fruit_strawberry_contect" src="<%=request.getContextPath()%>/resources/img/kitchenware/melonknife.jpg"></a>&nbsp;&nbsp;&nbsp;&nbsp;</td>
