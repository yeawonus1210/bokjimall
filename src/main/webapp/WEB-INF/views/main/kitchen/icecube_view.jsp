            ...
            <div class="row">
                ...
                <div class="col-lg-5">  
                    ...
                    <div id="form" class="card mb-4">
                        <img id="fruit_kiwi" src="<%=request.getContextPath()%>/resources/img/kitchenware/icecube.jpg">
                        <div class="card-body">
                            ...
                            <form>
                               <table id="kiwi_review">
                                  <tr>
                                     <td><img id="fruit_kiwi_review" src="<%=request.getContextPath()%>/resources/img/kitchenware/icecube.jpg">&nbsp;&nbsp;</td>
               ...
               <br><br>
               &nbsp;&nbsp;&nbsp;복지몰 1등 물품 상품 ! ! !
               <p id="title_kiwi">&nbsp;녹지않는 아이스큐브</p>
               <p id="dollar"><strong>&nbsp;&nbsp;10000원~</strong></p>
               <hr>
			   <br>
               <strong>&nbsp;&nbsp;&nbsp;👉👉혜택</strong>
               ...
               <center><p><strong>이 상품과 <span id="connect_t">연관된 상품!!!</span></strong></p>
               <form id="contect">
                  <table>
                     <tr>
                     
                     	<td><a href="${pageContext.servletContext.contextPath}/main/kitchen/meatstamper_view">
                        <img id="fruit_mango_contect" src="<%=request.getContextPath()%>/resources/img/kitchenware/meatstamper.jpg"></a>&nbsp;&nbsp;&nbsp;&nbsp;</td>

                        <td><a href="${pageContext.servletContext.contextPath}/main/kitchen/kitchenscissor_view">
                        <img id="fruit_strawberry_contect" src="<%=request.getContextPath()%>/resources/img/kitchenware/kitchenscissor.jpg"></a>&nbsp;&nbsp;&nbsp;&nbsp;</td>
                        
                        <td><a href="${pageContext.servletContext.contextPath}/main/kitchen/kitchenwareset_view">
                        <img id="fruit_peach_contect" src="<%=request.getContextPath()%>/resources/img/kitchenware/kitchenwareset.jpg"></a>&nbsp;&nbsp;&nbsp;&nbsp;</td>
