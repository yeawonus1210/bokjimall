            ...
            <div class="row">
                ...
                <div class="col-lg-5">  
                    ...
                    <div id="form" class="card mb-4">
                        <img id="fruit_kiwi" src="<%=request.getContextPath()%>/resources/img/kitchenware/kitchenscissor.jpg">
                        <div class="card-body">
                            <div class="small text-muted"><p id="font_red">상세 정보</p></div>
                            <p>2021년형<br>
                               갑각류도 손쉽게 자르기 가능 / 무겁지 않은 사용감 / 손쉬운 세척<br>
                            안정성 인증</p>
                            <hr>
                            <p class="card-text">
                            <form>
                               <table id="kiwi_review">
                                  <tr>
                                     <td><img id="fruit_kiwi_review" src="<%=request.getContextPath()%>/resources/img/kitchenware/kitchenscissor.jpg">&nbsp;&nbsp;</td>
                                     <td id="recommand"><center>⭐추천 리뷰⭐</center>
                                     <p>킹크랩 껍질까지 잘 잘리네요,, 대박
                ...
                <div class="col-lg-5">
                  ...
                  &nbsp;&nbsp;&nbsp;⭐⭐⭐⭐⭐ >> 6000개의 리뷰 더 보기
               <br><br>
               &nbsp;&nbsp;&nbsp;힘들이지 않고 단단한 것까지 자를 수 있는
               <p id="title_kiwi">&nbsp;고급 주방 가위</p>
               <p id="dollar"><strong>&nbsp;&nbsp;16,000원</strong></p>
               <hr>
            <br>
               <strong>&nbsp;&nbsp;&nbsp;👉👉혜택</strong>
               &nbsp;&nbsp;&nbsp;✔5개 이상 구매시 추가 1개 무료 증정<br>
               &nbsp;&nbsp;&nbsp;✔리뷰 등록 시 1,600원 복지포인트 적립<br>
               &nbsp;&nbsp;&nbsp;✔교환/반품 무료 
               <br>
               <br>
               ...
               <form id="contect">
                  <table>
                     <tr>
                        ...
                        <td><a href="${pageContext.servletContext.contextPath}/main/kitchen/mandootool_view">
                        <img id="fruit_mango_contect" src="<%=request.getContextPath()%>/resources/img/kitchenware/mandootool.jpg"></a>&nbsp;&nbsp;&nbsp;&nbsp;</td>
