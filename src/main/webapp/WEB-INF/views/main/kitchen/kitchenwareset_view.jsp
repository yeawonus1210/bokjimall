            ...
            <div class="row">
                ...
                <div class="col-lg-5">  
                    ...
                    <div id="form" class="card mb-4">
                        <img id="fruit_kiwi" src="<%=request.getContextPath()%>/resources/img/kitchenware/kitchenwareset.jpg">
                        <div class="card-body">
                            <div class="small text-muted"><p id="font_red">상세 정보</p></div>
                            <p>2021년형<br>
                              주방 필수템 8종 set / 올스텐  / 손쉬운 세척<br>
                            안정성 인증</p>
                            <hr>
                            <p class="card-text">
                            <form>
                               <table id="kiwi_review">
                                  <tr>
                                     <td><img id="fruit_kiwi_review" src="<%=request.getContextPath()%>/resources/img/kitchenware/kitchenwareset.jpg">&nbsp;&nbsp;</td>
                                     <td id="recommand"><center>⭐추천 리뷰⭐</center>
                                     <p>이거 세트 하나면 진심 다른거 하나도 안사도 됨. 대박
               ...
               <br><br>
               &nbsp;&nbsp;&nbsp;주방 필수템을 모두 모은
               <p id="title_kiwi">&nbsp;주방 용품 세트</p>
               <p id="dollar"><strong>&nbsp;&nbsp;60,000원</strong></p>
               <hr>
            <br>
               <strong>&nbsp;&nbsp;&nbsp;👉👉혜택</strong>
               &nbsp;&nbsp;&nbsp;✔모든 구매 고객에게 주방용품 걸이 증정<br>
               &nbsp;&nbsp;&nbsp;✔리뷰 등록 시 6,000원 복지포인트 적립<br>
               &nbsp;&nbsp;&nbsp;✔2세트 이상 구매 시 도마 무료 증정 
               <br>
               <br>
               ...
               <form id="contect">
                  <table>
                     <tr>
                        ...
                        <td><a href="${pageContext.servletContext.contextPath}/main/kitchen/kitchenscissor_view">
                        ...
                        <img id="fruit_mango_contect" src="<%=request.getContextPath()%>/resources/img/kitchenware/icecube.jpg"></a>&nbsp;&nbsp;&nbsp;&nbsp;</td>
                        
                        <td><a href="${pageContext.servletContext.contextPath}/main/kitchen/melonknife_view">
                        <img id="fruit_peach_contect" src="<%=request.getContextPath()%>/resources/img/kitchenware/melonknife.jpg"></a>&nbsp;&nbsp;&nbsp;&nbsp;</td>
