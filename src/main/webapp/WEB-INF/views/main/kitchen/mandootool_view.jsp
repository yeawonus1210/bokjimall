            ...
            <div class="row">
                ...
                <div class="col-lg-5">  
                    ...
                    <div id="form" class="card mb-4">
                        <img id="fruit_kiwi" src="<%=request.getContextPath()%>/resources/img/kitchenware/mandootool.jpg">
                        <div class="card-body">
                            <div class="small text-muted"><p id="font_red">상세 정보</p></div>
                            <p>2021년형<br>
                             쉬운 수제만두 만들기 가능 / 얇은 피에도 쉽게 찢어지지 않도록 설계 / 손쉬운 세척<br>
                       		안정성 인증</p>
                            <hr>
                            <p class="card-text">
                            <form>
                               <table id="kiwi_review">
                                  <tr>
                                     <td><img id="fruit_kiwi_review" src="<%=request.getContextPath()%>/resources/img/kitchenware/mandootool.jpg">&nbsp;&nbsp;</td>
                                     <td id="recommand"><center>⭐추천 리뷰⭐</center>
                                     <p>수제 만두 1초만에 빚기 가능해요 진짜 짱!
                ...
                <div class="col-lg-5">
                  ...
                  &nbsp;&nbsp;&nbsp;⭐⭐⭐⭐⭐ >> 4000개의 리뷰 더 보기
               <br><br>
               &nbsp;&nbsp;&nbsp;빠르게 수제 만두를 빚을 수 있게 해주는
               <p id="title_kiwi">&nbsp;만두 만들기 툴</p>
               <p id="dollar"><strong>&nbsp;&nbsp;5,000원</strong></p>
               <hr>
            <br>
               <strong>&nbsp;&nbsp;&nbsp;👉👉혜택</strong>
               &nbsp;&nbsp;&nbsp;✔5개 이상 구매시 추가 1개 무료 증정<br>
               &nbsp;&nbsp;&nbsp;✔리뷰 등록 시 500원 복지포인트 적립<br>
               &nbsp;&nbsp;&nbsp;✔주방용품 세트와 함께 구매시 3000원 할인 
               <br>
               <br>
               ...
               <form id="contect">
                  <table>
                     <tr>
                        ...
                        <td><a href="${pageContext.servletContext.contextPath}/main/kitchen/corncutter_view">
                        <img id="fruit_strawberry_contect" src="<%=request.getContextPath()%>/resources/img/kitchenware/corncutter.jpg"></a>&nbsp;&nbsp;&nbsp;&nbsp;</td>
                        
                        <td><a href="${pageContext.servletContext.contextPath}/main/kitchen/kitchenwareset_view">
                        <img id="fruit_mango_contect" src="<%=request.getContextPath()%>/resources/img/kitchenware/kitchenwareset.jpg"></a>&nbsp;&nbsp;&nbsp;&nbsp;</td>
                        
                        <td><a href="${pageContext.servletContext.contextPath}/main/kitchen/icecube_view">
                        <img id="fruit_peach_contect" src="<%=request.getContextPath()%>/resources/img/kitchenware/icecube.jpg"></a>&nbsp;&nbsp;&nbsp;&nbsp;</td>
