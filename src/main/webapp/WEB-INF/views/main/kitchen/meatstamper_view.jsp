            ...
            <div class="row">
                ...
                <div class="col-lg-5">  
                    ...
                    <div id="form" class="card mb-4">
                        <img id="fruit_kiwi" src="<%=request.getContextPath()%>/resources/img/kitchenware/meatstamper.jpg">
                        <div class="card-body">
                            <div class="small text-muted"><p id="font_red">상세 정보</p></div>
                            <p>2021년 제조<br>
                             힘들이지 않고 고기 다지기 / 영양소 파괴 방지 / 손쉬운 세척<br>
                       		안정성 인증</p>
                            <hr>
                            <p class="card-text">
                            <form>
                               <table id="kiwi_review">
                                  <tr>
                                     <td><img id="fruit_kiwi_review" src="<%=request.getContextPath()%>/resources/img/kitchenware/meatstamper.jpg">&nbsp;&nbsp;</td>
                                     <td id="recommand"><center>⭐추천 리뷰⭐</center>
                                     <p> 돈까스 만들 때 유용해요. 아이들이 재밌어 하고 좋아합니다.
               ...
               <br><br>
               &nbsp;&nbsp;&nbsp;힘들이지 않는
               <p id="title_kiwi">&nbsp;고기 다지기</p>
               <p id="dollar"><strong>&nbsp;&nbsp;25,000원</strong></p>
               <hr>
            <br>
               <strong>&nbsp;&nbsp;&nbsp;👉👉혜택</strong>
               &nbsp;&nbsp;&nbsp;✔2개 이상 구매시 만두 툴 무료 증정<br>
               &nbsp;&nbsp;&nbsp;✔리뷰 등록 시 2500원 복지포인트 적립<br>
               ...
               <form id="contect">
                  <table>
                     <tr>
                        ...
                        <img id="fruit_strawberry_contect" src="<%=request.getContextPath()%>/resources/img/kitchenware/kitchenwareset.jpg"></a>&nbsp;&nbsp;&nbsp;&nbsp;</td>
                        
                        <td><a href="${pageContext.servletContext.contextPath}/main/kitchen/melonknife_view">
                        <img id="fruit_mango_contect" src="<%=request.getContextPath()%>/resources/img/kitchenware/melonknife.jpg"></a>&nbsp;&nbsp;&nbsp;&nbsp;</td>
