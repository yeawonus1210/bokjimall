            ...
            <div class="row">
                ...
                <div class="col-lg-5">  
                    ...
                    <div id="form" class="card mb-4">
                        <img id="fruit_kiwi" src="<%=request.getContextPath()%>/resources/img/kitchenware/melonknife.jpg">
                        <div class="card-body">
                            ...
                            <form>
                               <table id="kiwi_review">
                                  <tr>
                                     <td><img id="fruit_kiwi_review" src="<%=request.getContextPath()%>/resources/img/kitchenware/melonknife.jpg">&nbsp;&nbsp;</td>
               ...
               <br><br>
               &nbsp;&nbsp;&nbsp;복지몰 1등 물품 상품 ! ! !
               <p id="title_kiwi">&nbsp;수박 전용칼</p>
               <p id="dollar"><strong>&nbsp;&nbsp;5000원</strong></p>
               <hr>
			   <br>
               <strong>&nbsp;&nbsp;&nbsp;👉👉혜택</strong>
               ...
               <form id="contect">
                  <table>
                     <tr>
                        ...
                        <td><a href="${pageContext.servletContext.contextPath}/main/kitchen/fishgoodbye_view">
                        <img id="fruit_strawberry_contect" src="<%=request.getContextPath()%>/resources/img/kitchenware/fishgoodbye.jpg"></a>&nbsp;&nbsp;&nbsp;&nbsp;</td>
                        
                        <td><a href="${pageContext.servletContext.contextPath}/main/kitchen/corncutter_view">
                        <img id="fruit_mango_contect" src="<%=request.getContextPath()%>/resources/img/kitchenware/corncutter.jpg"></a>&nbsp;&nbsp;&nbsp;&nbsp;</td>
                        
                        <td><a href="${pageContext.servletContext.contextPath}/main/kitchen/mandootool_view">
                        <img id="fruit_peach_contect" src="<%=request.getContextPath()%>/resources/img/kitchenware/mandootool.jpg"></a>&nbsp;&nbsp;&nbsp;&nbsp;</td>
