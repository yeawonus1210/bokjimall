...
<div class="box">
	<h2 class="reg">답글 페이지</h2>
	<br><br>
	<hr width="500" color="navy" />

	<table width="500" cellpadding="3" cellspacing="0" border="1" >
		<form action="${pageContext.servletContext.contextPath}/main/replyOk" method="post">
			...
			<tr>
				<td colspan = "2" align="center">
					<input class ="bt3"type="submit" value="답변전송">&nbsp;&nbsp;&nbsp;<a class="list_b" href="${pageContext.servletContext.contextPath}/main/qna">목록으로</a>
				</td>
			</tr>
		</form>	
	</table>
