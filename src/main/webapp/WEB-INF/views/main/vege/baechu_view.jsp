            ...
            <div class="row">
                ...
                <div class="col-lg-5">  
                    ...
                    <div id="form" class="card mb-4">
                        <img id="fruit_kiwi" src="<%=request.getContextPath()%>/resources/img/vegetable/baechu.jpg">
                        <div class="card-body">
                            <div class="small text-muted"><p id="font_red">상세 정보</p></div>
                            <p>굴보쌈과 함께 싸드시면 개꿀맛!!!<br>
                             겉절이에 특화된 배추!!<br>
                               어떤 음식과도 잘 어울려요!!</p>
                            <hr>
                            <p class="card-text">
                            <form>
                               <table id="asparagus_review">
                                  <tr>
                                     <td><img id="fruit_kiwi_review" src="<%=request.getContextPath()%>/resources/img/vegetable/baechu.jpg">&nbsp;&nbsp;</td>
               ...
               <br><br>
               &nbsp;&nbsp;&nbsp;복지몰 효자상품, 국내산 ! ! !
               <p id="title_kiwi">&nbsp;싱싱한 고랭지 배주</p>
               <p id="dollar"><strong>&nbsp;&nbsp;7,500원~</strong></p>
               <hr>
            <br>
               <strong>&nbsp;&nbsp;&nbsp;👉👉혜택</strong>
