            ...
            <div class="row">
                ...
                <div class="col-lg-5">  
                    ...
                    <div id="form" class="card mb-4">
                        <img id="fruit_kiwi" src="<%=request.getContextPath()%>/resources/img/vegetable/broccoli.jpg">
                        <div class="card-body">
                            <div class="small text-muted"><p id="font_red">상세 정보</p></div>
                            <p>싱싱한 브로콜리 한번 먹으면 또 먹고 싶어지는 맛<br>
                             끓는 물에 살짝 데친 후에 초장에 찍어먹으면 이게 바로 건강식<br>
                               어떤 음식과도 잘 어울려요!!</p>
                            <hr>
                            <p class="card-text">
                            <form>
                               <table id="asparagus_review">
                                  <tr>
                                     <td><img id="fruit_kiwi_review" src="<%=request.getContextPath()%>/resources/img/vegetable/broccoli.jpg">&nbsp;&nbsp;</td>
               ...
               <br><br>
               &nbsp;&nbsp;&nbsp;복지몰 효자상품, 국내산 ! ! !
               <p id="title_kiwi">&nbsp;싱싱한 브로컬리</p>
               <p id="dollar"><strong>&nbsp;&nbsp;1500원~</strong></p>
               <hr>
            <br>
               <strong>&nbsp;&nbsp;&nbsp;👉👉혜택</strong>
               ...
               <form id="contect">
                  <table>
                     <tr>
                        ...
                        <td><a href="${pageContext.servletContext.contextPath}/main/vege/chiculri_view">
                        <img id="fruit_mango_contect" src="<%=request.getContextPath()%>/resources/img/vegetable/chiculri.jpg"></a>&nbsp;&nbsp;&nbsp;&nbsp;</td>
