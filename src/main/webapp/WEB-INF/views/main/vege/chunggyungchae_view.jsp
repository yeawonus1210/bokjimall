            ...
            <div class="row">
                ...
                <div class="col-lg-5">  
                    ...
                    <div id="form" class="card mb-4">
                        <img id="fruit_kiwi" src="<%=request.getContextPath()%>/resources/img/vegetable/chunggyungchae.jpg">
                        <div class="card-body">
                            <div class="small text-muted"><p id="font_red">상세 정보</p></div>
                            <p>싱싱한 청경채 한번 먹으면 또 먹고 싶어지는 맛<br>
                            샤브샤브로 드시면 더 맛있어요<br>
                               어떤 음식과도 잘 어울려요!!</p>
                            <hr>
                            <p class="card-text">
                            <form>
                               <table id="kiwi_review">
                                  <tr>
                                     <td><img id="fruit_kiwi_review" src="<%=request.getContextPath()%>/resources/img/vegetable/chunggyungchae.jpg">&nbsp;&nbsp;</td>
               ...
               <br><br>
               &nbsp;&nbsp;&nbsp;복지몰 효자상품, 국내산 ! ! !
               <p id="title_kiwi">&nbsp;싱싱한 청경채</p>
               <p id="dollar"><strong>&nbsp;&nbsp;10,000원~</strong></p>
               <hr>
            <br>
               <strong>&nbsp;&nbsp;&nbsp;👉👉혜택</strong>
               ...
               <form id="contect">
                  <table>
                     <tr>
                        ...
                        <img id="fruit_strawberry_contect" src="<%=request.getContextPath()%>/resources/img/vegetable/corn.jpg"></a>&nbsp;&nbsp;&nbsp;&nbsp;</td>
                        ...
                        <td><a href="${pageContext.servletContext.contextPath}/main/vege/minari_view">
                        <img id="fruit_peach_contect" src="<%=request.getContextPath()%>/resources/img/vegetable/minari.jpg"></a>&nbsp;&nbsp;&nbsp;&nbsp;</td>
