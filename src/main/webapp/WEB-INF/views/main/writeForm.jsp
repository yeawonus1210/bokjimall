...
.bt {box-shadow:inset 0px 0px 9px -4px #97c4fe;
   background:linear-gradient(to bottom, #3d94f6 5%, #1e62d0 100%);
   background-color:#3d94f6; border-radius:8px; border:1px solid #337fed;
   display:inline-block; cursor:pointer; color:#ffffff; font-family:Arial;
   font-size:15px; font-weight:bold; padding:7px 16px; text-decoration:none;
...
class="absolute top-0 left-0 z-50 flex flex-col items-center justify-between hidden w-full h-64 pt-5 mt-24 text-sm text-gray-800 bg-white border-t border-gray-200 md:w-auto md:flex-row md:h-24 lg:text-base md:bg-transparent md:mt-0 md:border-none md:py-0 md:flex md:relative">
   ...
   <h2 class="reg">글쓰기 페이지</h2>
   
   <a class="list_h" href="${pageContext.servletContext.contextPath}/main/writeOk"><u>목록으로</u></a> 
   <table width="500" cellpadding="4" cellspacing="0" border="1">
      <form:form commandName="BVO" action="${pageContext.servletContext.contextPath}/main/writeOk" method="post">
         <tr>
            <th>작성자</th>
          ...
          <tr>
            <th>제목</th>
            <td><form:input path="bSubject" size="40"/></td>
         </tr>
         <tr>
            <th>내용</th>
            <td><form:textarea path="bContent" cols="40" rows = "8"/></td>
         </tr>
         
         <br><br>
         <tr>
            <td colspan="2" align="center"><input class="reg_b" type="submit"
             value="등록"/></td>
         </tr>         
      </form:form>
